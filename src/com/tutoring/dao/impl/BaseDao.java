...
import com.tutoring.dao.IBaseDao;
import com.tutoring.dao.util.ConditionQuery;
import com.tutoring.dao.util.OrderBy;
import com.tutoring.util.page.PageUtil;
...
public abstract class BaseDao<M extends Serializable, PK extends Serializable> implements IBaseDao<M, PK> {
    ...
    public Session getSession() {
        //娴滃濮熻箛鍛淬�閺勵垰绱戦崥顖滄畱(Required)閿涘苯鎯侀崚娆掑箯閸欐牔绗夐崚锟�
    ...
    /**
     * 閺嶈宓侀弻銉嚄閺夆�娆㈡潻鏂挎礀閸烆垯绔存稉锟芥蒋鐠佹澘缍�
     */
    @SuppressWarnings("unchecked")
    ...
    /**
     * 閹笛嗩攽閹电懓顦甸悶鍡氼嚔閸欙拷婵★拷娑斿妫縤nsert, update, delete 缁涳拷
     */
        ...
        if (paramlist != null) {
            for (int i = 0; i < paramlist.length; i++) {
                if(paramlist[i] instanceof Date) {
                    //TODO 闂呴箖浜炬潻娆愭Цbug 娴ｈ法鏁etParameter娑撳秷顢戦敍鐕傜吹
